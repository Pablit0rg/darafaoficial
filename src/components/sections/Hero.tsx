...
export default function Hero() {
  ...
  // Logica de ancoragem suave protegida (nao quebra o layout caso o elemento falte)
      ...
      >
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-brand-muted uppercase tracking-[0.3em] text-[10px] md:text-sm">
          ...
          <button 
            ...
            className="hover:text-white transition-colors cursor-pointer outline-none uppercase font-inherit"
          >
            Joias artesanais
          </button>
        </motion.p>
